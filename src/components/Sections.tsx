  ...
  <section id="mission" className="section-padding bg-background">
    <div className="container mx-auto max-w-4xl text-center">
      ...
      <motion.p {...fadeUp} transition={{ duration: 0.6, delay: 0.2 }} className="text-lg text-muted-foreground leading-relaxed">
        The mission of the <span className="font-semibold text-foreground">Global AI Assembly</span> is to educate and empower citizens to take an active role in the governance of AI and collect public opinion for the AI alignment process, ensuring that its development is driven by values of democracy, safety, and justice.
      </motion.p>
    </div>
  </section>
);
